          ...
          <ul class="nav">
              ...
              <li class="nav-item">
                ...
                <div class="collapse" id="ui-doctor">
                  <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="doctor-view.jsp">View Doctors</a></li>
              ...
              <li class="nav-item">
                ...
                <div class="collapse" id="ui-lab-test">
                  <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="lab-test-register-view.jsp">Test Register</a></li>
                    
                    <li class="nav-item"> <a class="nav-link" href="lab-test-result-view.jsp">Test Result</a></li>
                  </ul>
                </div>
              </li>
              ...
              <li class="nav-item">
                ...
                <div class="collapse" id="ui-patient">
                  <ul class="nav flex-column sub-menu">           
                    <li class="nav-item"> <a class="nav-link" href="patient-view.jsp">View Patient</a></li> 
                  </ul>
                </div>
              </li>
              <li class="nav-item">
                  ...
                  <div class="collapse" id="ui-lab-assistant">
                    <ul class="nav flex-column sub-menu">
                      <li class="nav-item"> <a class="nav-link" href="test-booking-view.jsp">View Test Booking</a></li>
                    ...
                    <div class="card">
                      <div class="card-body">
                        ...
                        <form class="forms-sample">
                          ...
                          <div class="form-group">
                            <label for="exampleInputTestType">Test Type</label>
                            <input type="text" class="form-control" id="exampleInputTestType" placeholder="Name">
                          </div>
        
                          <div class="form-group">
                            <label for="exampleInputName1">Test Sample ID</label>
                            <input type="text" class="form-control" id="exampleInputName1" placeholder="Name">
                          </div>

                          <button type="submit" class="btn btn-primary mr-2">Submit</button>
                          <button class="btn btn-light mr-2">Cancel</button>
                          <a href="lab-test-register-view.jsp" class="btn btn-dark ">Back</a>
