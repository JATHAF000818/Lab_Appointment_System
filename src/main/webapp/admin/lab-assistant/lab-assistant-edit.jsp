        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-doctor">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item"> <a class="nav-link" href="../../admin/doctor/doctor-create.jsp">Create Doctor</a></li>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-lab-assistant">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item"> <a class="nav-link" href="../../admin/lab-assistant/lab-assistant-create.jsp">Create Lab Assistants</a></li>
                  <li class="nav-item"> <a class="nav-link" href="#">Edit Lab Assistants</a></li>
                </ul>
              </div>
            </li>
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-lab-test">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="../../admin/lab-test/lab-test-view.jsp">View Lab Tests</a></li>
                  <li class="nav-item"> <a class="nav-link" href="../../admin/lab-test/lab-test-create.jsp">Create Lab Tests</a></li>
                  <li class="nav-item"> <a class="nav-link" href="#">Edit Lab Tests</a></li>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-patient">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item"> <a class="nav-link" href="../../admin/patient/patient-create.jsp">Create Patients</a></li>
                  <li class="nav-item"> <a class="nav-link" href="#">Edit Patients</a></li>
                </ul>
              </div>
            </li>
            ...
            <li class="nav-item">
              <a class="nav-link" data-toggle="collapse" href="#ui-patient" aria-expanded="false" aria-controls="ui-patient">
                <span class="icon-bg"><i class="mdi mdi-account menu-icon"></i></span>
                <span class="menu-title">Final Results</span>
                <i class="menu-arrow"></i>
              </a>
              <div class="collapse" id="ui-patient">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="../../admin/patient/patient-view.jsp">View Test Results</a></li>                            
                </ul>
              </div>
            </li>
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title">Edit Lab Assistant</h3>
                    ...
                    <div class="card">
                      <div class="card-body">
                        ...
                        <form class="forms-sample">
                          ...
                          <a href="Lab-assistant-view.jsp" class="btn btn-dark ">Back</a>
