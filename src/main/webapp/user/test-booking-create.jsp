            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-lab-test">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item"> <a class="nav-link" href="test-booking-view.jsp">View Test Result</a></li>
                </ul>
              </div>
            </li>
                      ...
                      <div class="card-body">
                        ...
                        <form class="forms-sample">
                          <div class="form-group">
                            <label for="exampleInputName1">Test Type</label>
                            <input type="text" class="form-control" id="exampleInputName1" placeholder="User Test Type">
                          </div>
                          <div class="form-group">
                            <label for="exampleInputEmail3">Doctor Name</label>
                            <input type="email" class="form-control" id="exampleInputEmail3" placeholder="Doctor Name">
                          </div>
                          <div class="form-group">
                            <label for="exampleInputPassword4">Date</label>
                            <input type="date" class="form-control" id="exampleInputPassword4" placeholder="Date">
                          </div>
                          ...
                          <a href="test-booking-view.jsp" class="btn btn-dark ">Back</a>
