              ...
              <div class="card-body px-5 py-5">
                ...
                <form action="Login" method="post">
                  <div class="form-group">
                    ...
                    <input type="email" name="email" placeholder="Enter Email" class="form-control p_input" required>
                  </div>
                  <div class="form-group">
                    <label>Password *</label>
                    <input type="text" name="password" placeholder="Enter Password" class="form-control p_input" required>
                  </div>
